...
int      mapXT(int sn);
void     noextcrash(int i, int loc);
void     verifystatus(int i, int stat);
int      isvisible(short i, short target);
void     getpicinfo(short picnum);
short    wallangle(int wn);
short    arbitraryangle(void);
short    wallnormal(int wn);
short    walldeflect(int wn, short angin);
short    spritedeflect(int sn, short angin);
void     tweakdeathdist(short i);
void     splash(int i);
